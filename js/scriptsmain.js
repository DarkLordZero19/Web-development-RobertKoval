...
//performance.now(): Возвращает время в миллисекундах с высокой точностью, начиная с момента, когда пользователь загрузил страницу.
//document.createElement(): Создает новый HTML-элемент. В данном случае — элемент <footer>.
//textContent: Свойство, которое устанавливает или возвращает текстовое содержимое элемента.
//appendChild(): Метод, который добавляет новый узел (элемент) в конец списка дочерних элементов родительского узла.